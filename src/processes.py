...
def run_generator(signal_queue, websocket_src_queue, source, sampler, sample_freq, window_length, opt):
    while True:
        ...
        container = WebsocketDataContainer(ServerProtocolPlot.SRC_DATA, cg.fft(orig_signal))
