...
# Title: Top Block
# Generated: Wed May  6 14:46:34 2015
##################################################
...
class top_block(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.cogradio_mc_sampling_0 = cogradio.mc_sampling(100, 6)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_gr_complex*1, samp_rate,True)
        self.blocks_stream_to_vector_0 = blocks.stream_to_vector(gr.sizeof_gr_complex*1, length)
        self.blocks_null_sink_0 = blocks.null_sink(gr.sizeof_gr_complex*length*6)
        ...
        self.connect((self.cogradio_mc_sampling_0, 0), (self.blocks_null_sink_0, 0))
