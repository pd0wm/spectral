...
This paper develops a novel-wavelet based approach for wideband CS. The time domain signal is fed to several filters, and the sub-Nyquist samples are utlized to detect wheter or not some part of the spectrum is occupied.
\end{document}