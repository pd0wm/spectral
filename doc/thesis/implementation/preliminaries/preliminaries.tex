...
\subsubsection{Nose}
\label{ssub:Nose}
In addition to the standard Python testing library \lib{Unittest}, the library \lib{nose} was used. This library provides some additional commands and checks which allow us to set up a more extensive test framework.
