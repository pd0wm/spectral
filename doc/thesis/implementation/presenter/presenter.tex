...
Managing system-wide settings and allowing the user to modify them at runtime are also tasks of the presenter. System settings, or runtime parameters are made available between different Python processes using the Python package \lib{Pyro4}.
