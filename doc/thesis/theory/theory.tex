...
\begin{figure}[H]
    \centering
    \begin{tikzpicture}
        \draw [red, thick] (-5, 0) -- (0, 3) -- (5, 0);
        \draw [blue, thick] (-2, 0) -- (0, 2) -- (2, 0);
        ...
        \draw [black, thick] (-5, -0.2) -- (-5, 0.2);
        \draw [black, thick] (-2, -0.2) -- (-2, 0.2);
        \draw [black, thick] (5, -0.2) -- (5, 0.2);
        \draw [black, thick] (2, -0.2) -- (2, 0.2);
        \draw (-5, 0) node[black, yshift=-0.5cm] {$-KL+1$};
        \draw (-2, 0) node[black, yshift=-0.5cm] {$-L+1$};
        \draw (5, 0) node[black, yshift=-0.5cm] {$-KL+1$};
        \draw (2, 0) node[black, yshift=-0.5cm] {$-L+1$};
