...
If $N$ is large enough, we can approximate the test statistics' distribution by a gaussian distributio as it it is the sum of $2N$ i.i.d. random variables, using the Central Limit theorem:
