...
If $N$ is large enough, we can approximate the test statistics' distribution by a Gaussian distribution as it it is the sum of $2N$ independt identically distributed random variables. By the central limit theorem,
