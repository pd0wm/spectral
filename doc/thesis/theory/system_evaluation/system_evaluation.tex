...
\draw   [fill=yellow, opacity=.1] (10,0) ellipse (.5 and .5);
\draw   [fill=yellow, opacity=.1] (10,2) ellipse (.5 and .5);
\draw   [fill=yellow, opacity=.1] (4,5) ellipse (.5 and .5);

\draw   (-3.5,3) ellipse (.5 and .5) node{SNR};
\draw  (10,0) ellipse (.5 and .5) node{$p\ss{fa}$};
\draw  (10,2) ellipse (.5 and .5) node{Type};
