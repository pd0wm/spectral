...
\end{axis}
\end{tikzpicture}
\caption{plot of down-sampling $N$ for a given amount of samplers $M$. red = minimal linear sparse, blue = ILP circular sparse, green = theoretical upper-bound}\label{fig:comparison_sparse_ruler}
\end{figure}
