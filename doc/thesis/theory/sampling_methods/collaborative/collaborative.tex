...
Collaborative sampling is very similar to circular sparse ruler, but differs in that it makes use of multiple devices. In this way, one device does not need to have the information for all lags, because other devices might have that information. This is illustrated in \cref{tkz:collaborative_ruler}, where $N=13$, $M=4$ with two devices.
...
\subsection{ci aanmaken}\label{sub:ci-collab}
blaatverhaal
