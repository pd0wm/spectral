...
\begin{tabularx}{\textwidth}{lX}
    ...
    & \underline{\hspace{0.3\linewidth}} en mijn e-mailadres is \underline{\hspace{0.5\linewidth}}. \\
\end{tabularx}
...
\begin{opinion}
    \opinionquestion{De \textit{techniek achter} de slimme stoorzender maakt kans binnen de markt van Defensie.}
